(function () {
      ...
      pieChart: [
        {
          color: "red",
          description:
            "Ipsem lorem text goes here. And foo goes bar goes baz. That's up!!!",
          title: "flowers",
          value: 0.62
        },
        {
          color: "blue",
          description:
            "Another ipsem text goes here. And baz goes bar goes foo. Oh yeah, whazzz up?",
          title: "trains",
          value: 0.38
        }
      ]
    ...
    function drawLineChart(elementId, data) {
      ...
      svg
        ...
        .attr(
          "transform",
          "translate(" + detailWidth / 2 + "," + (height + 7) + ")"
        )
        .call(xAxis);
      ...
      function showCircleDetail(data) {
        ...
        details
          ...
          .attr(
            "d",
            "M2.99990186,0 C1.34310181,0 0,1.34216977 0,2.99898218 L0,47.6680579 C0,49.32435 1.34136094,50.6670401 3.00074875,50.6670401 L44.4095996,50.6670401 C48.9775098,54.3898926 44.4672607,50.6057129 49,54.46875 C53.4190918,50.6962891 49.0050244,54.4362793 53.501875,50.6670401 L94.9943116,50.6670401 C96.6543075,50.6670401 98,49.3248703 98,47.6680579 L98,2.99898218 C98,1.34269006 96.651936,0 95.0000981,0 L2.99990186,0 Z M2.99990186,0"
          )
